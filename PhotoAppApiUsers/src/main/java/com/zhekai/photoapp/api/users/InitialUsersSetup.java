...
import com.zhekai.photoapp.api.users.data.AuthorityEntity;
import com.zhekai.photoapp.api.users.data.AuthorityRepository;
import com.zhekai.photoapp.api.users.data.RoleEntity;
import com.zhekai.photoapp.api.users.data.RoleRepository;
import com.zhekai.photoapp.api.users.data.UserEntity;
import com.zhekai.photoapp.api.users.data.UsersRepository;
import com.zhekai.photoapp.api.users.shared.Roles;
...
public class InitialUsersSetup {
	...
	adminUser.setFirstName("Gilbert");
	adminUser.setLastName("Ng");
